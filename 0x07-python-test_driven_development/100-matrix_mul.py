...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: if m_a and m_b is not a list
        TypeError: if m_a or m_b is not a list of lists
        TypeError: if one elemenr of list of lists is not an int/float
        TypeError: if row of m_a or m_b are not of the same size
